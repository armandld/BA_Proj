...
| D-112 | **RÉSERVÉ — la suite est ROUGE sur la branche vive : trois échecs déterministes, et ce sont les tests qui épinglaient l'état que `a0e0e02` a délibérément changé.** Rapport seul. Ligne posée avant écriture. | en cours | en cours |
