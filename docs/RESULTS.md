...
| D-114 | **RÉSERVÉ** — le garde-fou de l'invariant `theta_h ≡ theta_v` est une recherche de chaîne dans le source : faux vert et faux rouge mesurés, et il ne lit qu'un des deux appelants. Mesure en cours | — | — |
