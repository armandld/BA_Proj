...
| D-84 | *(réservé — phase 11E (`h2b_v1_hamiltonian_loso.py`) : ses deux colonnes « classiques » sortent de la même fonction et ne diffèrent que par la réduction vers la grille des patches (moyenne contre max) ; l'écart est imprimé comme un effet de physique)* | *en cours* | *en cours* |
