...
| D-107 | **RÉSERVÉ — `fig5_qaoa_detailed_analysis.py` : la profondeur 0 de sa courbe de coefficients emprunte un `dx` 128 fois plus petit que toutes les autres, et rend un Hamiltonien identiquement nul.** Mesure en cours. | — | — |
