...
## Les 51 défauts corrigés

*(51 lignes `D-N` distinctes dans les tables ci-dessous, plus 2 lignes non
numérotées — 53 corrections en tout. Le titre annonçait **41** pour 42 lignes
