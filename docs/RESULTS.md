...
| D-106 | **RÉSERVÉ — `fig12_depth_analysis.py`, panneau C : le « taux d'accord » divise par le domaine ENTIER, alors qu'à une profondeur donnée presque aucun pixel ne porte de décision.** Mesure en cours. | — | — |
