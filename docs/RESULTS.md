...
| D-82 | *(réservé — même défaut que D-81 dans `h2b_scenario_ablation.py` : le bras « fuzz » choisit son seuil sur les labels de validation, les trois autres colonnes de la même table sur le train)* | *en cours* | *en cours* |
