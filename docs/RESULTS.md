...
| D-81 | *(réservé — phase 12 : les bras VQC et QKE choisissent leur seuil sur les labels de VALIDATION, les bras classiques auxquels on les compare sur ceux d'entraînement)* | *en cours* | *en cours* |
