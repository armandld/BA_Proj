...
| D-85 | *(réservé — le critère d'acceptation de la tâche 4 (`h2b_blocked_split.py`) est imprimé en prose et jamais comparé : il ne peut pas échouer, et il échouerait)* | *en cours* | *en cours* |
