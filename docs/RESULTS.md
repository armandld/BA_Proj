...
## Les 63 défauts corrigés

*(61 lignes `D-N` distinctes dans les tables ci-dessous, plus 2 lignes non
numérotées — 63 corrections en tout, avant l'ajout de D-89 ci-dessous ; ce
sous-compte n'est pas revérifié ici, voir « Compte de tête inexact » plus
bas — signalé une fois, non recorrigé à chaque ajout. Le titre annonçait
**62** avant l'ajout de D-89 ; **60** avant l'ajout de D-73 ; **59** avant l'ajout de D-72 ; **58** avant l'ajout de D-71 ; **56** avant l'ajout de D-68 et D-70 (D-69 n'entre pas ici : rapport
