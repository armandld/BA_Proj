...
| D-75 | *(réservé — passe `study/h2b_prediction/`, 14 sites de balayage vide qui rendent la main avec le code 0 : forme sœur de D-56/D-74 que le détecteur AST ne voit pas)* | *en cours* | *en cours* |
| D-76 | *(réservé — deux lanceurs de `scripts/` invoquent des chemins disparus à la réorganisation `17d983d`, sites que le balayage de D-71 n'a pas couverts)* | *en cours* | *en cours* |
