...
| D-148 | **La famille D-55/D-56 (« un balayage vide doit crier ») a été déclarée fermée alors que 7 modules de `study/` sortent encore avec le code 0 sans rien écrire — dont les phases 2, 3, 4 et 5 du pipeline.** Réservé — mesures et correction poussées ensuite. | réservé | `pytest tests/study/test_empty_sweep_never_silent.py -q` |
