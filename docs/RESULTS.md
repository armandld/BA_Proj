...
| D-83 | *(réservé — troisième site de la famille D-81/D-82 : `h2b_random_split_bootstrap.py` choisit les seuils des bras appris sur les probabilités de validation, le bras classique auquel ils sont comparés sur le train)* | *en cours* | *en cours* |
