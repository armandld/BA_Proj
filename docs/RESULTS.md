...
| D-104 | **RÉSERVÉ — `fig7_physical_fidelity.py` : le bloc de perturbation « trial independence » tire un bruit DIFFÉRENT pour chacune des trois simulations censées être identiques.** Mesure en cours. | — | — |
