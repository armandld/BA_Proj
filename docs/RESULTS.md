...
| D-93 | **Réservé** — `figures/v1_legacy/fig_utils.py:109` : `FIG_DIR`, le répertoire où les 17 scripts de figures V1 écrivent, est ancré un niveau trop haut depuis la réorganisation `17d983d` | mesure en cours | `pytest tests/study/test_fig_utils_output_dir.py` |
