...
## Les 60 défauts corrigés

*(60 lignes `D-N` distinctes dans les tables ci-dessous, plus 2 lignes non
numérotées — 62 corrections en tout. Le titre annonçait **59** avant l'ajout
de D-72 ; **58** avant l'ajout de D-71 ; **56** avant l'ajout de D-68 et D-70 (D-69 n'entre pas ici : rapport
