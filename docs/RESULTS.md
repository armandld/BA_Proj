...
## Les 50 défauts corrigés

*(50 lignes `D-N` distinctes dans les tables ci-dessous, plus 2 lignes non
numérotées — 52 corrections en tout. Le titre annonçait **41** pour 42 lignes
