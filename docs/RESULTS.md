...
| D-119 | **Le `K_opt` gelé des scénarios a été réglé sous COBYLA, et le CLI de déploiement optimise par défaut avec L-BFGS-B** — rapport seul, trancher est une décision | à `K_opt = 20` : COBYLA **20/20 évaluations**, L-BFGS-B **50–115**, Powell **176–377** | `pytest tests/quantum/test_optimiser_axis.py` |
