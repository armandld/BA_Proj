...
| D-120 | **`test_the_three_supported_optimizers_keep_the_bound[COBYLA]` passe avec les contraintes de COBYLA ENTIEREMENT retirees** — le garde ne peut pas echouer sur le bras qui porte 317 appels sur 320 | contraintes retirees, depart a froid : **VERT** ; depart chaud `beta = 1.0` : **1,082 / 0,947 / 1,037** contre une borne de **0,3927**, 3 sur 3 hors borne | `pytest tests/quantum/test_runtime_contracts.py -k keep_the_bound` |
