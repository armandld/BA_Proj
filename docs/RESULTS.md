...
| D-77 | *(réservé — 84 des 156 artefacts `patches_*.npz` portent un `classical_scores` que le code ne reproduit plus : convention de rotationnel d'avant D-1. Rapport seul)* | *en cours* | *en cours* |
