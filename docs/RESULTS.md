...
## Les 49 défauts corrigés

*(49 lignes `D-N` distinctes dans les tables ci-dessous, plus 2 lignes non
numérotées — 51 corrections en tout. Le titre annonçait **41** pour 42 lignes
