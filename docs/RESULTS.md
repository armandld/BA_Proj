...
| D-68 | *(en cours — passe Vigil du 14 août, `src/visual.py` / `src/help_visual.py`, les deux modules que l'inventaire excluait comme « aucune valeur numérique produite ». Numéro réservé avant rédaction, cf. VIGIL_BA_Proj.md)* | — | — |
