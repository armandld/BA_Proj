...
Six modules de plus « vérifiés et trouvés sains » pour éviter de les
relire (deux du 22 août, quatre de cette passe). 77 drapeaux `scripts=0`
restent dans la file.
