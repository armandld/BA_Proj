...
python study/v4/t16_aggregate_v4.py                                # 180 rows, 0 DIFF, 0 MISSING
```
...
fresh clone),
**325 pytests passed** (15 skipped), master table **180/180 OK, 0 DIFF, 0 MISSING** — nothing outstanding.
...
Markdown. It prints `0 DIFF` over 180 rows.
...
> better (all 4 folds; 12/40 draws abort against 0/16 classical).
