...
that are checked into `logs/Result_phase*.txt`. The numbers are reported
to 3 decimals -- more than adequate for a bar chart.

Outputs:
  figures/fig1_ceiling_bar.png    -- classical / SA / QAOA-equiv /
                                     mean-field / neighbourhood / LOSO
  figures/fig2_loso_scatter.png   -- per-scenario F1_site vs F1_class
