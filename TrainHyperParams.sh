...
# ============================================================
# Training of Q-HAS: Quantum-Hierarchical Adaptive Steering
# ============================================================
...
run_stage "Training Hyperparameters" python "$SCRIPTS_LOC/TrainHyperParam_v3.py" \
    2>&1 | tee -a "$LOG_FILE"
...
# -----------------------------
log "=============================================================="
log "🎉 Training of Q-HAS completed successfully!"
