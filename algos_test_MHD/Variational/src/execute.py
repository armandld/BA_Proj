...
def main():
    parser = argparse.ArgumentParser(description="Execute QAOA circuit")
    ...
    circuit_file = os.path.join(args.out_dir, "var_circuit.qpy")
    with open(circuit_file, "rb") as f:
        circuits = qpy.load(f)  # load returns a list of circuits
