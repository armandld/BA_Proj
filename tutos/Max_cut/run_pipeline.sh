...
OUT_DIR="$ROOT_DIR/tutos/Max_cut/results"
...
# -----------------------------
run_stage "Mapping" python "$SCRIPTS_LOC/mapping.py" --backend "$BACKEND" --nodes "$NODES" --edges "$EDGES" --out-dir "$OUT_DIR" $([ "$VERBOSE" = true ] && echo "--verbose")
