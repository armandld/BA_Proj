...
OUT_DIR="$ROOT_DIR/tutos/VQA/results"
...
display_help() {
    ...
    echo "  --out-dir <dir>                 Output directory (default: results)"
    echo "  --verbose                       Enable verbose logging"
    echo "  --skip-cleanup                  Skip deleting previous results"
    echo ""
...
log "=============================================================="
log "🚀 Starting Quantum MaxCut Pipeline"
...
# -----------------------------
run_stage "Mapping" python "$SCRIPTS_LOC/mapping.py" --backend "$BACKEND" --out-dir "$OUT_DIR" $([ "$VERBOSE" = true ] && echo "--verbose")
stop_if_reached "mapping"

# -----------------------------
# 2️⃣ Quantum Circuit Optimization
# -----------------------------
run_stage "Optimization" python "$SCRIPTS_LOC/optimize.py" --backend "$BACKEND" --out-dir "$OUT_DIR" $([ "$VERBOSE" = true ] && echo "--verbose")
...
# -----------------------------
log "=============================================================="
log "🎉 Quantum VQA pipeline completed successfully!"
