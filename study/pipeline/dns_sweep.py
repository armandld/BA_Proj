...
Usage:
  python study/dns_sweep.py                     # all combos
  python study/dns_sweep.py --re 800 1200       # specific Re values
  python study/dns_sweep.py --scenario orszag_tang --re 400
  python study/dns_sweep.py --N 512             # high-res run
"""
