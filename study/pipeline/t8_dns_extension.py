...
Enveloppe (wrapper) de `study/phase1_dns_sweep.py` — JAMAIS modifie en
place. Ajoute :
...
Usage :
  python study/v3/t8_dns_extension.py --dry-run           # plan + cout
  python study/v3/t8_dns_extension.py                     # tout (heures)
  python study/v3/t8_dns_extension.py --scenario lamb_oseen --re 400 \
...
def make_labels(dns_path, dims, results_dir, seed):
    ...
    from phase2_hard_patches import analyze_dns_file
