...
sys.path.insert(0, _HERE)                      # study/v3
...
from t1b_cone_curve import blocked_split_indices, khop_features
from t4_blocked_split import ranking_metrics_per_snapshot
from t5_v1_psi_loso import block_agg, psi_signed_v1, signed_combine
...
def _gather(by_scene, dim, max_snaps, beta4):
    ...
    from phase11_upper_bound import extract_features_2d, N_FEATS
    from phase4_exact_diag import build_patch_hamiltonian
    from phase11e_v1h_loso import v1_state
...
def main():
    ...
    from config import (RESULTS_DIR, SCENARIOS, RE_VALUES, DNS_N,
                        TRAINED_BETA)
    from phase11_upper_bound import make_model, fit_eval, best_threshold_f1
