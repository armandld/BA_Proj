...
sys.path.insert(0, os.path.join(_HERE, ".."))  # study/ : config, phase11*
sys.path.insert(0, _HERE)                      # study/v3 : t1_*

from t1_feature_selection import git_commit_hash, loso_f1_subset
...
def capped_model_factory(n_features, seed, base_factory=None):
    ...
    if base_factory is None:
        from phase11_upper_bound import make_model
...
def _gather_feats_per_snapshot(by_scene, dim, max_snaps):
    ...
    from phase11_upper_bound import extract_features_2d
    out = {}
