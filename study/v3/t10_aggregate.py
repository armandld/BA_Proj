...
Usage :
  python study/v3/t10_aggregate.py --N 256 --dim 4
  python study/v3/t10_aggregate.py --strict     # code retour != 0 si
                                                # DIFF ou MISSING
"""
...
def to_markdown(rows, git_hash):
    lines = ["# V3 master table",
             "",
             f"Generated by `study/v3/t10_aggregate.py` at commit "
