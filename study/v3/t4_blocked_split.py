...
from t1b_cone_curve import blocked_split_indices
...
def _gather(by_scene, dim, max_snaps):
    ...
    from phase11_upper_bound import extract_features_2d, N_FEATS, _block_avg
...
def main():
    ...
    print("\n  acceptance refs (Task 0): B2 random F1 = 0.475, "
          "B4 gbt-9 (max) random F1 = 0.980")
