...
display_help() {
    ...
    echo "  --method <"COBYLA", "L-BFGS-B", "Powell">               Optimization method for minimize (default: L-BFGS-B)"
...
log "=============================================================="
log "🚀 Starting Q-HAS: Quantum-Hierarchical Adaptive Steering Pipeline - Variational Workflow"
